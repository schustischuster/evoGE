This folder contains files with the expression data for the angiosperm (DevSeq data set) and mammalian [(Brawand)](https://pubmed.ncbi.nlm.nih.gov/22012392/) 1-1 ortholog genes. 
