...
## Perform comparative analysis of DevSeq and Brawand data sets

This code allows to reproduce the inter-organ intra-species, inter-species and cross-kingdom analyses of the DevSeq and Brawand data sets. 
