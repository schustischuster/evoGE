...
Two measures of non-linear expression distances are retrieved for each organ: the Pearson distance, preserved as a metric, and an expression distance estimated under the Ornstein-Uhlenbeck model [(Yang et al., 2019)](https://pubmed.ncbi.nlm.nih.gov/31609424/). Both distances are calculated between all species pairs across the entire phylogenetic tree.
