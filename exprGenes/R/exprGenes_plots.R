...
label_col <- c(roo="#6e509e", hyp="#808dc2", int="#0c703d", lea="#109450", cot="#109450", 
	cau="#109450", ape="#f4dc28", flo="#da68ab", sep="#84cd6a", pet="#ead1c7", 
	sta="#f43b37", pol="#9f3b31", car="#f2a529", fru="#b04082", see="#e9a3b3")
